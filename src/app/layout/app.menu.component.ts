            ...
            this.model = [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'List des Chauffeurs', icon: 'pi pi-fw pi-id-card', routerLink: ['/admin/ListDesTransporteurs'] },
                        { label: 'Statistique', icon: 'pi pi-fw pi-id-card', routerLink: ['/admin/Statistique'] },
                        { label: 'Rapports sur les commandes', icon: 'pi pi-fw pi-id-card', routerLink: ['/admin/Raports'] },
                        { label: 'Notifications', icon: 'pi pi-fw pi-id-card', routerLink: ['/admin/Notifications'] },
